"""Build the course notebooks with nbformat.

The source is kept as ordinary Python so notebook structure can be reviewed,
tested, and regenerated without hand-editing JSON.
"""
...
def write_notebook(relative_path: str, cells: list) -> None:
    """Write one deterministic Python notebook."""
...
def build_supervised_overview() -> None:
    """Create the first course notebook."""
    ...
    cells = [
        ...
        markdown("## 14. Visualization of classification results"),
        code(
            """
    ...
    write_notebook("01_supervised_learning/00_supervised_learning_overview.ipynb", cells)


def main() -> None:
    build_supervised_overview()
    print("Built 01_supervised_learning/00_supervised_learning_overview.ipynb")
